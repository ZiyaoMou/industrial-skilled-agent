...
This repository now includes a FastAPI + React MVP for industrial skill orchestration scenarios:

- Quality root cause copilot (8D/QRQC)
- Equipment anomaly diagnosis and work-order assistant
- Operations daily/weekly report agent
...
Open `http://localhost:5173` and see details in [docs/SKILL_BUILD_PLATFORM.md](docs/SKILL_BUILD_PLATFORM.md).
